				...
				<ul class="nav navbar-nav">
       			...
       			<form class="navbar-form navbar-right" role="search">
        				<div class="form-group" id="the-basics">
          					<input type="text" class="form-control-perso typeahead" placeholder="Search for a speaker">
        				</div>
        				<button type="submit" class="button-perso" style="border: 0; background: transparent">
    						<img src="http://localhost/laravel5/public/images/loupe.png" width="25" height="25" alt="submit" />
						</button>
      			</form>
